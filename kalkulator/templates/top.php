...
<head>
    ...
    <link rel="stylesheet" href="<?php print(_APP_URL);?>/css/boostrap-theme.css">
    ...
    <link rel="stylesheet" href="http://yui.yahooapis.com/pure/0.6.0/pure-min.css%22%3E">
</head>
<body>
<div class="navbar navbar-inverse navbar-fixed-top headroom" >
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img width="50px" src="<?php print(_APP_ROOT);?>/images/calculator.png" alt="Progressus HTML5 template"></a>
            </div>
